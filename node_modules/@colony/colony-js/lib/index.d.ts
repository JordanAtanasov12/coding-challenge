...
export { TokenClient, ColonyTokenClient, Erc20TokenClient, DaiTokenClient, } from './clients/TokenClient';
...
export * from './helpers';
export declare type ColonyClient = ColonyClientV1 | ColonyClientV2 | ColonyClientV3 | ColonyClientV4;
export declare type ContractClient = ColonyClient | ColonyNetworkClient | OneTxPaymentClient | OneTxPaymentFactoryClient | TokenClient | TokenLockingClient;
